...
export function FoodSummaryCard() {
  ...
  const {
    ...
    progressLabel,
    barFillPercent,
  } = useActionProgress("food");
  const progressPercentLabel = `${Math.round(percent)}%`;

  return (
    <View
      accessible
      accessibilityLabel={`${FOOD_CARD_TITLE}. ${progressLabel}. ${progressPercentLabel}`}
      ...
      <View style={styles.bodyRow}>
        ...
        <View style={styles.valueColumn}>
          ...
          <View style={styles.barRow}>
            <ActionProgressBar
              sources={getActionRowBarSources(foodRow)}
