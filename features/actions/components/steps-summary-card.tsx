...
export function StepsSummaryCard() {
  ...
  const {
    ...
    progressLabel,
    barFillPercent,
  } = useActionProgress("steps");
  const progressPercentLabel = `${Math.round(percent)}%`;

  return (
    <View
      accessible
      accessibilityLabel={`${STEPS_CARD_TITLE}. ${progressLabel}. ${progressPercentLabel}`}
      ...
      <View style={styles.bodyRow}>
        ...
        <View style={styles.valueColumn}>
          ...
          <View style={styles.barRow}>
            <ActionProgressBar
              sources={getActionRowBarSources(stepsRow)}
