...
export function CaloriesSummaryCard() {
  ...
  const {
    ...
    progressLabel,
    barFillPercent,
  } = useActionProgress("calories");
  const progressPercentLabel = `${Math.round(percent)}%`;

  return (
    <View
      accessible
      accessibilityLabel={`${CALORIES_CARD_TITLE}. ${progressLabel}. ${progressPercentLabel}`}
    ...
    >
      ...
      <View style={styles.bodyRow}>
        <Image
          ...
          source={CALORIES_ACTION_CARD_ICON}
          style={styles.icon}
          contentFit="contain"
        />
        <View style={styles.valueColumn}>
          ...
          <View style={styles.barRow}>
            <ActionProgressBar
              sources={getActionRowBarSources(caloriesRow)}
